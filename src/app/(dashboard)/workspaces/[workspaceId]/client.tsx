...
import { useGetWorkspaceAnalytics } from '@/features/workspaces/api/use-get-worksapce-analytics'
...
export const WorkspaceIdClient = () => {
  ...
  if (!analytics || !tasks || !projects || !members) {
    return <PageError message="Ошибка загрузки рабочего пространства" />
  }
    ...
    <div className="flex flex-col gap-y-4 col-span-1">
      <div className="bg-muted rounded-lg p-4">
        ...
        <ul className="flex flex-col gap-y-4">
          ...
          <li className="text-sm text-muted-foreground text-center hidden first-of-type:block">Задачи не нейдены</li>
        </ul>
    ...
    <div className="flex flex-col gap-y-4 col-span-1">
      <div className="bg-white border rounded-lg p-4">
        ...
        <ul className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <li className="text-sm text-muted-foreground text-center hidden first-of-type:block">Проекты не нейдены</li>
        </ul>
      </div>
    </div>
  )
    ...
    <div className="flex flex-col gap-y-4 col-span-1">
      <div className="bg-white border rounded-lg p-4">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <li className="text-sm text-muted-foreground text-center hidden first-of-type:block">Участники не нейдены</li>
        </ul>
      </div>
    </div>
  )
